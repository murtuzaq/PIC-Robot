 ...
 * Author: mquaizar
 *
 * Created on February 1, 2017, 1:31 PM
 */

#ifndef MCU_CONFIG_1_H
#define	MCU_CONFIG_1_H
...
// CONFIG1L
#pragma config PLLDIV = 4       // PLL Prescaler Selection bits (16Mhz Input)
